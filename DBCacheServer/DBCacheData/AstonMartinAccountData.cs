...
{
    public class AstonMartinAccountData
    {
        /// <summary>唯一碼</summary>
        ...
        public int RP_Times { get; set; }
        public int GP_Times { get; set; }
        public int YP_Times { get; set; }
        public int RR_Times { get; set; }
        public int GR_Times { get; set; }
        public int YR_Times { get; set; }
        ...
        public void AccumulatecCacheData(string field, string value)
        {
            ...
            else if (field == "RR_Times") RR_Times += Convert.ToInt32(value);
            else if (field == "GR_Times") GR_Times += Convert.ToInt32(value);
            else if (field == "YR_Times") YR_Times += Convert.ToInt32(value);
        }
        ...
        public Dictionary<string, string> GetUpdateData(bool detail)
        {
            ...
            updata.Add("RR_Times", RR_Times.ToString());
            updata.Add("GR_Times", GR_Times.ToString());
            updata.Add("YR_Times", YR_Times.ToString());
        ...
        public void GetDBData(Dictionary<string, string> datalist, bool detail)
        {
            ...
            RR_Times = Convert.ToInt32(datalist["RR_Times"]);
            GR_Times = Convert.ToInt32(datalist["GR_Times"]);
            YR_Times = Convert.ToInt32(datalist["YR_Times"]);
