...
{
    public class OceanKing7AccountData
    {
        /// <summary>唯一碼</summary>
        ...
        //BOSS魚種
        public int RockSkull_Times;
        public double RockSkull_Bet;
        public double RockSkull_Win;
        public int VampireKing_Times;
        public double VampireKing_Bet;
        public double VampireKing_Win;
        public int GhostShip_Times;
        public double GhostShip_Bet;
        public double GhostShip_Win;
        ...
        public int Bat_Times;
        public double Bat_Bet;
        public double Bat_Win;
        ...
        public void AccumulatecCacheData(string field, string value)
        {
            ...
            else if (field == "RockSkull_Times") RockSkull_Times += Convert.ToInt32(value);
            else if (field == "RockSkull_Bet") RockSkull_Bet += Convert.ToDouble(value);
            else if (field == "RockSkull_Win") RockSkull_Win += Convert.ToDouble(value);
            else if (field == "VampireKing_Times") VampireKing_Times += Convert.ToInt32(value);
            else if (field == "VampireKing_Bet") VampireKing_Bet += Convert.ToDouble(value);
            else if (field == "VampireKing_Win") VampireKing_Win += Convert.ToDouble(value);
            else if (field == "GhostShip_Times") GhostShip_Times += Convert.ToInt32(value);
            else if (field == "GhostShip_Bet") GhostShip_Bet += Convert.ToDouble(value);
            else if (field == "GhostShip_Win") GhostShip_Win += Convert.ToDouble(value);
            ...
            else if (field == "Bat_Times") Bat_Times += Convert.ToInt32(value);
            else if (field == "Bat_Bet") Bat_Bet += Convert.ToDouble(value);
            else if (field == "Bat_Win") Bat_Win += Convert.ToDouble(value);
        }
        ...
        public Dictionary<string, string> GetUpdateData(bool detail)
        {
            ...
            updata.Add("RockSkull_Times", RockSkull_Times.ToString());
            updata.Add("RockSkull_Bet", RockSkull_Bet.ToString());
            updata.Add("RockSkull_Win", RockSkull_Win.ToString());
            updata.Add("VampireKing_Times", VampireKing_Times.ToString());
            updata.Add("VampireKing_Bet", VampireKing_Bet.ToString());
            updata.Add("VampireKing_Win", VampireKing_Win.ToString());
            updata.Add("GhostShip_Times", GhostShip_Times.ToString());
            updata.Add("GhostShip_Bet", GhostShip_Bet.ToString());
            updata.Add("GhostShip_Win", GhostShip_Win.ToString());
            ...
            updata.Add("Bat_Times", Bat_Times.ToString());
            updata.Add("Bat_Bet", Bat_Bet.ToString());
            updata.Add("Bat_Win", Bat_Win.ToString());
        ...
        public void GetDBData(Dictionary<string, string> datalist, bool detail)
        {
            ...
            RockSkull_Times = Convert.ToInt32(datalist["RockSkull_Times"]);
            RockSkull_Bet = Convert.ToDouble(datalist["RockSkull_Bet"]);
            RockSkull_Win = Convert.ToDouble(datalist["RockSkull_Win"]);
            VampireKing_Times = Convert.ToInt32(datalist["VampireKing_Times"]);
            VampireKing_Bet = Convert.ToDouble(datalist["VampireKing_Bet"]);
            VampireKing_Win = Convert.ToDouble(datalist["VampireKing_Win"]);
            GhostShip_Times = Convert.ToInt32(datalist["GhostShip_Times"]);
            GhostShip_Bet = Convert.ToDouble(datalist["GhostShip_Bet"]);
            GhostShip_Win = Convert.ToDouble(datalist["GhostShip_Win"]);
            ...
            Bat_Times = Convert.ToInt32(datalist["Bat_Times"]);
            Bat_Bet = Convert.ToDouble(datalist["Bat_Bet"]);
            Bat_Win = Convert.ToDouble(datalist["Bat_Win"]);
